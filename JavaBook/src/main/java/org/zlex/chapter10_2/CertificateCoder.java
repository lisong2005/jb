...
public abstract class CertificateCoder {
     ...
     * @throws Exception
     */
    public static PrivateKey getPrivateKeyByKeyStore(String keyStorePath, String alias,
     ...
     * @throws Exception
     */
    private static X509Certificate getCertificate(String certificatePath) throws Exception {
