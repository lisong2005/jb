...
public class CertificateCoderTest {
    ...
    public void test1() {
        ...
        try {
            ...
            // 私钥解密
            byte[] decrypt = CertificateCoder.decryptByPrivateKey(encrypt, keyStorePath, alias,
                password);
    ...
    public void test2() {
        ...
        try {
            // 私钥加密
            byte[] encodedData = CertificateCoder.encryptByPrivateKey(data, keyStorePath, alias,
                password);
