...
public class Server extends JFrame {
    ...
    private void initButtonPanel() {
        ...
        JButton sendButton = new JButton(Messages.getString("Server.button.send"));
    ...
    private void send() {
        ...
        if (!request.isEmpty()) {
            ...
            try {
                ...
                String protocolResponse = new String(httpPost(addressTextField.getText().trim(),
                    request.getBytes(CHARACTER_ENCODING)), CHARACTER_ENCODING);
     ...
     * @throws Exception
     */
    public static byte[] httpPost(String urlString, byte[] requestData) throws Exception {
