...
public class SSLSecurity {
     ...
     * @throws Exception
     */
    public static SSLSocket getSSLClientSocket(String clientStorePath, String clientStorePassword,
                                               String serverStorePath, String serverStorePassword,
                                               String ip, int port) throws Exception {
        SSLContext context = getSSLContext(clientStorePath, clientStorePassword, serverStorePath,
            serverStorePassword);
