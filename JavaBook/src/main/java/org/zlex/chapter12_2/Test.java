...
public class Test extends Thread {
    ...
    public void run() {
        try {
            ...
            SSLSocket socket = SSLSecurity.getSSLClientSocket(CERT_CLIENT, PASSWORD_CLIENT,
                CERT_SERVER, PASSWORD_SERVER, "127.0.0.1", PORT);
    ...
    public static void main(String[] args) throws Exception {
        ...
        SSLServerSocket serverSocket = SSLSecurity.getSSLServerSocket(CERT_SERVER, PASSWORD_SERVER,
            CERT_CA, PASSWORD_CA, PORT);
